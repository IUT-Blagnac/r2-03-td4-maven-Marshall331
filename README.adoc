...
KHALIL Ahmad <ahmad31100@live.fr>
v1, 2022-02-20 : Initial draft

// PARTIE Modifiée :

1. Exécuter la commande mvn clean pour tout nettoyer.
2. Exécuter la commande mvn compile pour compiler
3. Pour obtenir un fichier jar (exécutable), exécutez la commande mvn package, un fichier .jar sera crée
